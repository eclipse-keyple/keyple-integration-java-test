...
dependencies {
    testImplementation("org.calypsonet.terminal:calypsonet-terminal-reader-java-api:1.3.0")
    ...
    testImplementation("org.eclipse.keyple:keyple-service-java-lib:2.3.0")
