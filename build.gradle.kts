...
dependencies {
    ...
    testImplementation("org.eclipse.keyple:keyple-service-java-lib:2.1.1-SNAPSHOT") { isChanging = true }
    testImplementation("org.eclipse.keyple:keyple-plugin-stub-java-lib:2.1.0")
    testImplementation("org.eclipse.keyple:keyple-card-calypso-java-lib:2.2.3-SNAPSHOT") { isChanging = true }
